"""
AdderBoard submission: 6-parameter adder transformer (GPU-trained, pure numpy).
...
The 6 learned parameters (found by optimizer):
  ...
  v_proj_w  = -6689.18   — V projection scalar
  gate_w0   = -17615.8   — tied gate weight (digit-sum threshold)
  gate_w1   = 124018.0   — tied gate weight (carry-mix slope)
  carry_w   =     0.3374 — shared carry projection scalar
"""
...
# ── The 6 GPU-trained parameter values ──────────────────────────────────────

PARAMS = np.array([
    524.278992,      # embed_w0
    0.001588,        # embed_w1
    -6689.177734,    # v_proj_w
    -17615.791016,   # gate_w0
    124017.960938,   # gate_w1
    0.337380,        # carry_w
], dtype=np.float64)
